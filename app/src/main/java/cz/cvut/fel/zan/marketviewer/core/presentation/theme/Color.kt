...
val SecondaryLight = Color(0xFF665E4F)
val OnSecondaryLight = Color(0xFFFFFFFF)
val TertiaryLight = Color(0xFF426841)
val BackgroundLight = Color(0xFFFFFBFF)
val SurfaceLight = Color(0xFFF7F3EA)
val OnBackgroundLight = Color(0xFF1E1B16)
val OnSurfaceLight = Color(0xFF1E1B16)
val ErrorLight = Color(0xFFBA1A1A)
val OnErrorLight = Color(0xFFFFFFFF)

val PrimaryContainerLight = Color(0xFF151107)

val OnPrimaryContainerLight = Color(0xFFCBAD52)